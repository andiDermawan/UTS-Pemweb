                ...
                <div class="container-xl">
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <h3 class="card-title mb-0"><i class="ti ti-building-community me-2 text-blue"></i>Daftar
                                Program Studi
                            </h3>
                            <form method="GET" action="program_studi.php"
                                ...
                                <?php if ($search): ?>
                                    <a href="program_studi.php" class="btn btn-sm btn-ghost-secondary"><i
                                            class="ti ti-x me-1"></i>Reset</a>
                                <?php endif; ?>
                            </form>
                        </div>
                        ...
                        <?php if (empty($prodis)): ?>
                            <div class="card-body">
                                <div class="empty">
                                    <div class="empty-img"><i class="ti ti-inbox" style="font-size:4rem;color:#94a3b8"></i>
                                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><a
                                                    href="<?= sortUrl('jumlah', $sort, $search) ?>">Jumlah
                                        ...
                                        <?php foreach ($prodis as $index => $prodi):
                                            ...
                                            <tr>
                                                <td class="text-center text-muted">
                                                    <small><?= str_pad($index + 1, 3, '0', STR_PAD_LEFT) ?></small>
                                                </td>
                                                <td><strong><?= htmlspecialchars($prodi['nama_prodi']) ?></strong></td>
                                                <td class="text-center"><span
                                                        class="badge rounded-pill bg-<?= $color ?> text-white"><?= $count ?></span>
                                                </td>
            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
                                class="ti ti-x me-1"></i>Batal</button>
                        <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i>Simpan
                            Perubahan</button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <form method="POST" id="deleteForm" class="w-100">
                        ...
                        <button type="submit" class="btn btn-danger w-100"><i class="ti ti-trash me-1"></i>Ya,
                            Hapus</button>
                    </form>
